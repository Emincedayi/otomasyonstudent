...
public class otomasyonstudentDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        otomasyonstudentGlobalFeatureConfigurator.Configure();
        otomasyonstudentModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<otomasyonstudentDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<otomasyonstudentResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/otomasyonstudent");

            options.DefaultResourceType = typeof(otomasyonstudentResource);
        ...
        {
            options.MapCodeNamespace("otomasyonstudent", typeof(otomasyonstudentResource));
        });
    }
}
