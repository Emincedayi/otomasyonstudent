...
public class otomasyonstudentDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public otomasyonstudentDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
