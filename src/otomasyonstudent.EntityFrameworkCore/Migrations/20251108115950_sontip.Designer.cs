...
{
    [DbContext(typeof(otomasyonstudentDbContext))]
    [Migration("20251108115950_sontip")]
    partial class sontip
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("otomasyonstudent.Attendances.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("otomasyonstudent.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("otomasyonstudent.Enrollments.Enrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("otomasyonstudent.Grades.Grade", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("otomasyonstudent.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("otomasyonstudent.Teachers.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("otomasyonstudent.Attendances.Attendance", b =>
                {
                    b.HasOne("otomasyonstudent.Enrollments.Enrollment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("otomasyonstudent.Courses.Course", b =>
                {
                    b.HasOne("otomasyonstudent.Teachers.Teacher", null)
                        .WithMany()
            ...
            modelBuilder.Entity("otomasyonstudent.Enrollments.Enrollment", b =>
                {
                    b.HasOne("otomasyonstudent.Courses.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("otomasyonstudent.Students.Student", null)
                        .WithMany()
